...
base_url = "https://fi.wiktionary.org/wiki/Luokka:Suomen_kielen_kaksitavuiset_sanat"
...
with open("finnish_two-syllable_words.csv", mode="w", newline='', encoding='utf-8') as csv_file:
    ...
    for adj in all_adjs:
        writer.writerow({'word': adj, 'type': 'two-syllable'})

print("Data saved to finnish_two-syllable_words_wiki_19.10.2023.csv")
